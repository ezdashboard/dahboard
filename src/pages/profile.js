...
const onSubmit = (e) => {
  ...
  if(!inputData.password){
    ...
    axios.post(`http://122.160.48.132/dev/vikas/react-backend/updatePass.php`,inputData,{
      headers: {
...
useEffect(() => {
  ...
  <Head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Nunito&amp;display=swap" rel="stylesheet" crossOrigin="anonymous"/>
    <link href="https://kit-pro.fontawesome.com/releases/v5.15.3/css/pro.min.css" rel="stylesheet" crossOrigin="anonymous"/>
    <script
